...
function Sidebar(_ref) {
  ...
  const [inputValues, setInputValues] = (0,react.useState)({
    "Go to x:__ y:__": {
      x: "",
      y: ""
    },
  ...
  const handleDropOnSidebar = e => {
    ...
    try {
      ...
      if (source === "midarea" && Array.isArray(sprites)) {
        ...
        const updatedSprites = sprites.map(sprite => sprite.id === spriteId ? {
          ...sprite,
          actions: sprite.actions.filter(action => action.id !== actionId)
        } : sprite);
  ...
  }, Object.entries(actionBlocks).map(_ref2 => {
    let [category, blocks] = _ref2;
    return /*#__PURE__*/react.createElement("div", {
      key: category,
      className: "mb-4 w-full"
    }, /*#__PURE__*/react.createElement("div", {
      className: "font-bold mb-1"
    }, category), blocks.map((block, index) => /*#__PURE__*/react.createElement("div", {
      key: index,
      draggable: true,
      onDragStart: e => {
        const action = {
      ...
      className: `flex flex-row items-center px-2 py-1 my-1 text-sm cursor-pointer rounded ${category === "Motion" ? "bg-blue-500" : category === "Looks" ? "bg-purple-500" : "bg-yellow-500"} text-white`
    }, renderLabelWithInputs(block.label, inputValues[block.label]))));
  }));
}
;// ./src/components/ActionBlock.js

const ActionBlock = _ref => {
  let {
    action,
    activeSprite,
  ...
  }, /*#__PURE__*/react.createElement("span", null, formatActionLabel(action)), /*#__PURE__*/react.createElement("button", {
    onClick: () => removeAction(activeSprite.id, action.id),
    className: "bg-red-600 text-white text-xs px-2 py-1 rounded hover:bg-red-700"
  }, "\u2715"));
};
/* harmony default export */ const components_ActionBlock = (ActionBlock);
...
function MidArea(_ref) {
  ...
  const [draggedIndex, setDraggedIndex] = (0,react.useState)(null);
  const formatActionLabel = action => {
    ...
    if (action.label === "Say __ for __ seconds" && action.inputs) {
      return `Say "${action.inputs.message || "Default"}" for ${action.inputs.duration || 2} seconds`;
    }
    if (action.label === "Think __ for __ seconds" && action.inputs) {
      return `Think "${action.inputs.message || "Default"}" for ${action.inputs.duration || 2} seconds`;
    }
  ...
  const handleActionDrop = (e, spriteId) => {
    ...
    try {
      ...
      const updatedAction = {
        ...
        backgroundColor: categoryToColor[actionObject.category] || "bg-gray-500"
      };
      setSprites(prev => prev.map(sprite => sprite.id === spriteId ? {
        ...sprite,
        actions: [...sprite.actions, updatedAction]
      } : sprite));
    } catch (error) {
  ...
  const removeAction = (spriteId, actionId) => {
    setSprites(prev => prev.map(sprite => sprite.id === spriteId ? {
      ...sprite,
      actions: sprite.actions.filter(action => String(action.id) !== String(actionId))
    } : sprite));
  };
      ...
      setSprites(prev => {
        const newSprites = prev.map(sprite => {
          if (sprite.id === spriteId) {
            ...
            const draggedIndex = newActions.findIndex(action => action.id === draggedActionId);
            const dropIndex = newActions.findIndex(action => action.id === dropActionId);
            ...
            console.log("Reordered actions:", newActions.map(a => a.label));
            return {
              ...sprite,
              actions: newActions
            };
  ...
  (0,react.useEffect)(() => {
    if (sprites.length > 0 && (activeTab === undefined || activeTab >= sprites.length)) {
      setActiveTab(0);
    }
  }, [sprites, activeTab]);
  if (!sprites || sprites.length === 0) {
    return /*#__PURE__*/react.createElement("div", null, "No sprites available");
  }
  const activeSprite = sprites[activeTab];
  if (!activeSprite) {
    return /*#__PURE__*/react.createElement("div", null, "Selected sprite not found");
  }
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: `tab py-2 px-4 rounded-t-md ${activeTab === index ? "bg-blue-500 text-white" : "bg-gray-300"}`
  }, sprite.name || sprite.id))), /*#__PURE__*/react.createElement("div", {
    className: "action-area",
    onDrop: e => handleActionDrop(e, activeSprite.id),
    onDragOver: handleDragOver
  }, /*#__PURE__*/react.createElement("h2", null, "Actions for Sprite ", activeSprite.name || activeSprite.id), activeSprite.actions.map(action => /*#__PURE__*/react.createElement(components_ActionBlock, {
    action: action,
...
const Sprite = _ref => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    draggable: false
  }), sprite.speechBubble && /*#__PURE__*/react.createElement("div", {
    className: `absolute -top-12 left-1/2 transform -translate-x-1/2 p-2 text-sm rounded-lg max-w-[120px] text-center z-50 ${sprite.speechBubble.type === "say" ? "bg-white border border-gray-300" : "bg-gray-200 border border-gray-400"}`,
    style: {
      pointerEvents: "none",
      wordBreak: "break-word"
    }
  }, sprite.speechBubble.message), /*#__PURE__*/react.createElement("button", {
...
const ControlPanel = _ref => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "flex gap-2 justify-center border-t p-2 bg-gray-50"
  }, /*#__PURE__*/react.createElement("button", {
    className: `bg-green-500 text-white px-4 py-2 font-bold rounded cpanel ${isPlaying ? "opacity-50 cursor-not-allowed" : ""}`,
    onClick: playActions,
    disabled: isPlaying
  }, "Play Actions"), /*#__PURE__*/react.createElement("button", {
    className: "bg-blue-500 text-white px-4 py-2 rounded font-bold cpanel",
    onClick: () => setIsModalOpen(true)
  }, "Add Sprite"));
};
/* harmony default export */ const components_ControlPanel = (ControlPanel);
;// ./src/components/SpriteModal.js

const SpriteModal = _ref => {
  let {
    spriteOptions,
    selectedSprite,
    setSelectedSprite,
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    className: "absolute inset-0 bg-black bg-opacity-0 flex items-center justify-center z-10"
  }, /*#__PURE__*/react.createElement("div", {
    className: "bg-white p-6 rounded-xl shadow-lg w-[300px] text-center"
  }, /*#__PURE__*/react.createElement("h2", {
    className: "text-lg font-semibold mb-4"
  }, "Choose a Sprite"), /*#__PURE__*/react.createElement("div", {
    className: "flex flex-wrap gap-2 justify-center mb-4"
  }, spriteOptions.map(s => /*#__PURE__*/react.createElement("button", {
    key: s.name,
    onClick: () => setSelectedSprite(s.src),
    className: `p-1 border rounded hover:bg-gray-200 ${selectedSprite === s.src ? "ring-2 ring-blue-500" : ""}`
  }, /*#__PURE__*/react.createElement("img", {
    src: s.src,
    alt: s.name,
...
/* harmony default export */ const components_SpriteModal = (SpriteModal);
...
const PreviewArea = _ref => {
  let {
    sprites,
    setSprites
  } = _ref;
  const [selectedSprite, setSelectedSprite] = (0,react.useState)(spriteOptions[0].src);
  const [isModalOpen, setIsModalOpen] = (0,react.useState)(false);
  const [isInitial, setIsInitial] = (0,react.useState)(true);
  const [canvasSize, setCanvasSize] = (0,react.useState)({
    width: 500,
    height: 350
  });
  const [isPlaying, setIsPlaying] = (0,react.useState)(false);
  const draggingSprite = (0,react.useRef)(null);
  ...
  const handleActionDrop = (e, spriteId) => {
    ...
    try {
      ...
      setSprites(prev => prev.map(s => s.id === spriteId ? {
        ...s,
  ...
  const checkCollision = (a, b) => {
    ...
    const distance = Math.sqrt((centerA.x - centerB.x) ** 2 + (centerA.y - centerB.y) ** 2);
  ...
  const swapActions = (id1, id2) => {
    setSprites(prev => {
      ...
      if (i1 !== -1 && i2 !== -1) {
        [clone[i1].actions, clone[i2].actions] = [[...clone[i2].actions], [...clone[i1].actions]];
      }
      return clone;
    });
  };
  const executeSingleAction = async (sprite, action, allSprites, updateState) => {
    ...
    if (action.label === "Go to x:__ y:__") {
      ...
      const collided = allSprites.find(s => s.id !== currentSprite.id && checkCollision(temp, s));
      if (collided && !isInitial) {
        ...
        const updatedSpriteIndex = updatedSprites.findIndex(s => s.id === currentSprite.id);
        const collidedSpriteIndex = updatedSprites.findIndex(s => s.id === collided.id);
        if (updatedSpriteIndex !== -1 && collidedSpriteIndex !== -1) {
          [updatedSprites[updatedSpriteIndex].actions, updatedSprites[collidedSpriteIndex].actions] = [[...updatedSprites[collidedSpriteIndex].actions], [...updatedSprites[updatedSpriteIndex].actions]];
          currentSprite = {
            ...currentSprite,
      ...
      pos = target;
      updateState(prev => prev.map(s => s.id === currentSprite.id ? {
        ...s,
        position: pos
      } : s));
      ...
      await new Promise(resolve => setTimeout(resolve, 200)); // Simulate animation
    } else if (["Say __ for __ seconds", "Think __ for __ seconds"].includes(action.label)) {
  ...
  const executeSpriteActions = async (sprite, allSprites, updateState) => {
    ...
    for (const action of currentSprite.actions) {
      currentSprite = await executeSingleAction(currentSprite, action, allSprites, updateState);
  ...
  const playActions = async () => {
    ...
    for (const sprite of sprites) {
      const updatedSprite = await executeSpriteActions(sprite, updated, updater => {
  ...
  const handleMouseMove = e => {
    ...
    setSprites(prev => prev.map(s => s.id === draggingSprite.current ? {
      ...s,
      position: {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "p-2 w-full h-[400px] relative overflow-visible"
  }, sprites.map(sprite => /*#__PURE__*/react.createElement(components_Sprite, {
    sprite: sprite,
    handleMouseDown: handleMouseDown,
    handleActionDrop: handleActionDrop,
    removeSprite: removeSprite
  }))), /*#__PURE__*/react.createElement(components_ControlPanel, {
    setIsModalOpen: setIsModalOpen,
    playActions: playActions,
    isPlaying: isPlaying
  }), isModalOpen && /*#__PURE__*/react.createElement(components_SpriteModal, {
...
function App() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("nav", {
    ...
    className: "flex-1 h-full flex flex-row bg-white border-t border-r border-gray-200 rounded-tr-xl mr-2"
    ...
    className: "w-1/3 h-full bg-white border-t border-l border-gray-200 rounded-tl-xl ml-2"
